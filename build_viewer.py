...
<body>
    ...
    <div class="controls-panel">
        ...
        <div class="nav-hint">
            <strong>Navigation:</strong> Left-drag to Rotate | Right-drag to Pan | Scroll to Zoom | Click any town pin for history.
        </div>
    </div>
...
print(f"Successfully generated {viewer_path} ({len(html_content)} bytes)")
